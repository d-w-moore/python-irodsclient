    ...
    def test_put_get_parallel_autoswitch_A__235(self):
        ...
        with self.create_resc_hierarchy(Root) as (Root_ , Leaf):
            ...
            try:
                ...
                with helpers.enableLogging(logger, logging.StreamHandler, (PUT_LOG,), level_ = logging.INFO):
                ...
                with helpers.enableLogging(logger, logging.StreamHandler, (GET_LOG,), level_ = logging.INFO):
