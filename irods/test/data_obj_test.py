...
class TestDataObjOps(unittest.TestCase):
    ...
    def test_data_create_and_put_with_force_options_on_and_force_defaults_False__issue_132(self):
        with config.loadlines(
            entries=[
    ...
    def test_data_create_and_put_with_force_options_on_and_force_defaults_True__issue_132(self):
        with config.loadlines(
            entries=[
    ...
    def test_data_create_and_put_with_no_force_options_and_default_force_off__issue_132(self):
    ...
    def _dataobj_create_given_default_and_parameter_values__issue_132(self,param):
        ...
        try:
            ...
            self.assertEqual(Data.open(test_path,"r").read(), b"old", "Data object contents do not match expectation.")
            return False
        else:
    ...
    def test_force_create_options_resolve_correctly_observing_defaults__issue_132(self):
        ...
        for param in (False,True,None):
            ...
            with self.subTest(f"Original default = {forcedef}, force_param = {param}"):
                self.assertEqual(self._dataobj_create_given_default_and_parameter_values__issue_132(param),
