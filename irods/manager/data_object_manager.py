...
class DataObjectManager(Manager):
    ...
    def open(self, path, mode, create = True, finalize_on_close = True,
             returned_values = None, allow_redirect = True,
             auto_close = client_config.getter('data_objects','auto_close'), **options):
