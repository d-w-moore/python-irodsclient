        ...
        **options,
        ...
        """Create and return a new iRODSGroup.
           ...
           -----------------
               ...
               user_type: (deprecated parameter) This can be safely defaulted.
               user_zone: (deprecated parameter) In iRODS 4.3+, groups may not be made for a remote zone.
               auth_type: (deprecated parameter) Groups do not need authentication.
               group_admin: If left to its default value, allows a groupadmin to create new groups.
        """
