...
def save(root = None, string='', file = ''):
    ...
    but this can be overridden by supplying a nonzero string in the 'file' parameter.
    """
    _file = None
...
def load(root = None, file = '', failure_modes = (), logging_level = logging.WARNING):
    ...
    The 'file' parameter, when set to a nonzero length string, provides an override for
